...
parser.add_argument('--data', default='trivago', help='data name: xing/last')
parser.add_argument('--dataset', default='all_data', help='dataset name: all_data/sample')
...
if __name__ == '__main__':
    ...
    elif opt.data == 'trivago':
        all_data = pd.read_csv(r'./datasets/trivago.csv')
